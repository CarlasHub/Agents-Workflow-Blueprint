...
25. Find the narrowest file path and smallest behavioural lever.
26. Avoid style rewrites, package changes, and architecture churn unless required.
27. Prefer a small, well-tested fix to a broad speculative improvement.
28. Explain why each omitted tempting change was intentionally omitted.
