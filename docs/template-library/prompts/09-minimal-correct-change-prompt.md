...
26. Find the narrowest file path and smallest behavioural lever.
27. Avoid style rewrites, package changes, and architecture churn unless required.
28. Prefer a small, well-tested fix to a broad speculative improvement.
29. Explain why each omitted tempting change was intentionally omitted.
