...
26. Search imports, references, routes, configs, tests, docs, and generated manifests before deletion.
27. Prove that deletion will not remove documented behaviour or teaching examples.
28. Remove in layers when uncertainty exists.
29. Record the exact search evidence used for every removal.
