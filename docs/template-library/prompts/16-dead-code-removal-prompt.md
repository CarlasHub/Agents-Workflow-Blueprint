...
25. Search imports, references, routes, configs, tests, docs, and generated manifests before deletion.
26. Prove that deletion will not remove documented behaviour or teaching examples.
27. Remove in layers when uncertainty exists.
28. Record the exact search evidence used for every removal.
