...
26. Define unchanged behaviour explicitly before refactoring.
27. Create checkpoints where behaviour can be compared before and after.
28. Reject refactors that mix redesign with preservation work.
29. Keep naming and boundaries clearer after the change than before.
