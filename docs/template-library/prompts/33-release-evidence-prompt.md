...
25. Assemble a release decision from files, commands, manual checks, docs, and limitations.
26. Reject release narratives that omit known gaps.
27. Make “go”, “no-go”, or “limited acceptance” traceable to evidence.
28. Ensure public-facing claims match verification scope.
