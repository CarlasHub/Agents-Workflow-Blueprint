...
26. Compare previous claims to files, commands, and observable behaviour.
27. Classify each claim as proven, contradicted, unsupported, or outside scope.
28. Look for missing verification that a confident agent would prefer not to mention.
29. Reject “done” language when the only proof is a summary.
