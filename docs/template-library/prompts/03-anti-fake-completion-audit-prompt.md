...
25. Compare previous claims to files, commands, and observable behaviour.
26. Classify each claim as proven, contradicted, unsupported, or outside scope.
27. Look for missing verification that a confident agent would prefer not to mention.
28. Reject “done” language when the only proof is a summary.
