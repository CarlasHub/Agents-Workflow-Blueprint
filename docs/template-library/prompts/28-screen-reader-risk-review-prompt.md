...
25. Inspect what a user would hear, not only what appears visually.
26. Check names, descriptions, landmarks, headings, live regions, form errors, and route changes.
27. Identify ambiguity from duplicate labels or icon-only actions.
28. Separate likely screen-reader risk from directly verified assistive-technology evidence.
