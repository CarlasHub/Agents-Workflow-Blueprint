...
26. Inspect what a user would hear, not only what appears visually.
27. Check names, descriptions, landmarks, headings, live regions, form errors, and route changes.
28. Identify ambiguity from duplicate labels or icon-only actions.
29. Separate likely screen-reader risk from directly verified assistive-technology evidence.
