...
25. Identify state owner, writers, readers, derived values, and reset conditions.
26. Check for stale values after navigation, filtering, reload, permissions, and errors.
27. Look for duplicated sources of truth and hidden state coupling.
28. Ensure state behaviour can be tested without excessive internals.
