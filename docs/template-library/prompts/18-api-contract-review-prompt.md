...
26. Compare schemas, docs, clients, examples, tests, and error cases.
27. Identify breaking changes, silent default changes, and optionality drift.
28. Check how consumers discover and handle failures.
29. Require migration notes for contract changes.
