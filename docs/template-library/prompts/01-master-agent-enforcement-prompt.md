...
26. Combine scope control, evidence collection, adversarial review, and final-status discipline in one operating frame.
27. Require a decision on which specialist prompt, skill, or contract should be attached to the task.
28. Treat the repository instructions as higher priority than any convenient implementation shortcut.
29. Make the agent produce a reviewable trail, not just a final answer.
