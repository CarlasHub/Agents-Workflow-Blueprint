...
26. Translate the feature into user-visible behaviours and acceptance checks.
27. Check how the feature should appear in docs, tests, and release evidence.
28. Inspect related features so the new work does not create inconsistent UX.
29. Ensure incomplete sub-features are labelled as limitations, not implied capabilities.
