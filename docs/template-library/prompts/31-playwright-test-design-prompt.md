...
25. Design tests around roles, labels, and real user journeys.
26. Use traces, screenshots, and ARIA snapshots where they clarify failures.
27. Avoid brittle selectors when accessible locators are available.
28. Add assertions that would fail for the actual risk.
