...
26. Compare the surface to existing tokens, components, state patterns, and naming conventions.
27. Flag one-off CSS that should be a reusable pattern.
28. Check whether icons, labels, and button hierarchy remain consistent.
29. Document where the design system needs expansion rather than workaround styling.
