...
25. Compare the surface to existing tokens, components, state patterns, and naming conventions.
26. Flag one-off CSS that should be a reusable pattern.
27. Check whether icons, labels, and button hierarchy remain consistent.
28. Document where the design system needs expansion rather than workaround styling.
