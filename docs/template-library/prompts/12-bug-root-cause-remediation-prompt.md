...
25. Reproduce or logically isolate the bug before fixing it.
26. Differentiate trigger, root cause, symptom, and collateral damage.
27. Search for sibling bugs created by the same pattern.
28. Add or describe a regression check that would fail before the fix.
