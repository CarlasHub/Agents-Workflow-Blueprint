...
25. Assign confidence by claim, not by overall answer.
26. Distinguish source-inspected, command-tested, user-observed, and inferred conclusions.
27. Lower confidence when evidence is indirect, stale, or outside the current runtime.
28. State what evidence would upgrade the status to verified.
