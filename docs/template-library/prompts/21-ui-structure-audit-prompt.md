...
26. Review visual order, semantic order, reading order, and interaction order together.
27. Identify whether the layout communicates the task hierarchy in seconds.
28. Check cards, forms, tables, nav, and CTAs for grouping and alignment defects.
29. Report defects with location and visible impact.
