...
25. Review visual order, semantic order, reading order, and interaction order together.
26. Identify whether the layout communicates the task hierarchy in seconds.
27. Check cards, forms, tables, nav, and CTAs for grouping and alignment defects.
28. Report defects with location and visible impact.
