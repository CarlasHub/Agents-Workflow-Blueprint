...
25. Trace the datum from origin to every place it affects users or logs.
26. Identify transformations, validation, caching, and display formatting.
27. Check for sensitive-data exposure at each boundary.
28. Report uncertainty where the path cannot be followed end to end.
