...
26. Trace the datum from origin to every place it affects users or logs.
27. Identify transformations, validation, caching, and display formatting.
28. Check for sensitive-data exposure at each boundary.
29. Report uncertainty where the path cannot be followed end to end.
