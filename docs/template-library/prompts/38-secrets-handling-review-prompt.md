...
25. Search for secrets in source, docs, logs, examples, config, and CI surfaces.
26. Check storage, access, rotation, redaction, and incident response assumptions.
27. Ensure sample values cannot be mistaken for real credentials.
28. Reject logging or screenshots that expose sensitive values.
