...
26. Choose semantic fixes before ARIA fixes.
27. Prove accessible name, role, state, value, and keyboard behaviour after remediation.
28. Document residual manual checks needed for assistive technology confidence.
29. Reject changes that only silence automated tools.
