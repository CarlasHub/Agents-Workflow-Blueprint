...
25. Choose semantic fixes before ARIA fixes.
26. Prove accessible name, role, state, value, and keyboard behaviour after remediation.
27. Document residual manual checks needed for assistive technology confidence.
28. Reject changes that only silence automated tools.
