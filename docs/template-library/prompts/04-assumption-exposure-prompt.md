...
25. List assumptions before evaluating solutions.
26. Turn each assumption into a question, inspection target, or blocked item.
27. Identify assumptions that affect security, accessibility, architecture, and release claims.
28. Prevent a plausible narrative from replacing evidence.
