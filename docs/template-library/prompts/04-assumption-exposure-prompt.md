...
26. List assumptions before evaluating solutions.
27. Turn each assumption into a question, inspection target, or blocked item.
28. Identify assumptions that affect security, accessibility, architecture, and release claims.
29. Prevent a plausible narrative from replacing evidence.
