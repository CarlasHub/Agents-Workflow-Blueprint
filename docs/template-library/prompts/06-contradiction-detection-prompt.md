...
26. Cross-check README, site copy, catalogue, manifest, scripts, and examples.
27. Look for old names, stale counts, broken links, and mismatched limitations.
28. Treat contradictions as defects even when each individual file reads well.
29. Require one authoritative source of truth for repeated claims.
