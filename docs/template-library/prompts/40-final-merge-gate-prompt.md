...
26. Collect all specialist reviews and unresolved risks before verdict.
27. Check branch hygiene, docs truth, release evidence, and required commands.
28. Reject partial work that would mislead a future maintainer.
29. Produce a final decision with exact blockers or acceptance conditions.
