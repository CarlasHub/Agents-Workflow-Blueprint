...
25. Collect all specialist reviews and unresolved risks before verdict.
26. Check branch hygiene, docs truth, release evidence, and required commands.
27. Reject partial work that would mislead a future maintainer.
28. Produce a final decision with exact blockers or acceptance conditions.
