...
25. Compare the change to existing architecture, not to an imagined ideal architecture.
26. Identify dependency direction, ownership boundaries, and layering violations.
27. Recommend contained corrections that do not expand task risk unnecessarily.
28. Name any architectural debt that should be tracked separately.
