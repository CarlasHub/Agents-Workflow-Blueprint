...
25. Walk the journey using only keyboard operations.
26. Record focus order, focus visibility, trapped focus, skipped controls, and return focus.
27. Check dialogs, menus, popovers, tables, forms, and custom widgets.
28. Treat mouse-only completion as not verified.
