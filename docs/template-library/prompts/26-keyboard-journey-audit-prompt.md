...
26. Walk the journey using only keyboard operations.
27. Record focus order, focus visibility, trapped focus, skipped controls, and return focus.
28. Check dialogs, menus, popovers, tables, forms, and custom widgets.
29. Treat mouse-only completion as not verified.
