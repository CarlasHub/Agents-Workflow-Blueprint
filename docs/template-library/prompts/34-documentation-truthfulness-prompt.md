...
26. Compare docs to actual files, scripts, examples, and capabilities.
27. Remove unsupported capability claims and stale instructions.
28. Add limitations where the repo only proves workflow scaffolding.
29. Check that examples do not teach users to overclaim.
