...
25. Compare docs to actual files, scripts, examples, and capabilities.
26. Remove unsupported capability claims and stale instructions.
27. Add limitations where the repo only proves workflow scaffolding.
28. Check that examples do not teach users to overclaim.
