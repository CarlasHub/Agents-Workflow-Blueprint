...
25. Check whether the icon communicates meaning without surrounding context.
26. Verify accessible name, tooltip behaviour, focus visibility, hit target, and disabled state.
27. Look for repeated icons that require disambiguated names.
28. Require text labels when recognition risk is high.
