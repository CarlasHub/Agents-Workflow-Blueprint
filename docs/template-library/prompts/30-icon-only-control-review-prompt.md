...
26. Check whether the icon communicates meaning without surrounding context.
27. Verify accessible name, tooltip behaviour, focus visibility, hit target, and disabled state.
28. Look for repeated icons that require disambiguated names.
29. Require text labels when recognition risk is high.
