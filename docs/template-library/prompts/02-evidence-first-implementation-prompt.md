...
26. Start by defining the exact behaviour that would prove success.
27. Create evidence before confidence: inspect, change, run, compare, disclose.
28. Do not allow screenshots, tests, or docs to stand alone when the task requires multiple evidence types.
29. Make every changed file justify itself against the original request.
