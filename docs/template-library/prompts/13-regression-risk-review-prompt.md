...
26. Map adjacent behaviours likely to change unintentionally.
27. Focus on shared components, contracts, data flows, and public claims.
28. Require evidence that the old behaviour still works where preservation is expected.
29. Rank risks by likelihood and user or maintainer impact.
