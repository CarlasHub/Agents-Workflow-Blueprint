...
25. Write failure scenarios before solution polishing.
26. Include human process failure, agent shortcut failure, and technical regression failure.
27. Convert each likely failure into a prevention action.
28. Do not bury high-impact low-visibility risks.
