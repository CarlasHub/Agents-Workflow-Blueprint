...
26. Inspect spacing rhythm, type scale, emphasis, contrast, visual balance, and density.
27. Check whether the interface looks intentional rather than assembled from defaults.
28. Separate objective defects from aesthetic suggestions.
29. Require before/after screenshot evidence when visual work is claimed.
