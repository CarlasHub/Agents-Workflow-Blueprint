...
25. Inspect spacing rhythm, type scale, emphasis, contrast, visual balance, and density.
26. Check whether the interface looks intentional rather than assembled from defaults.
27. Separate objective defects from aesthetic suggestions.
28. Require before/after screenshot evidence when visual work is claimed.
