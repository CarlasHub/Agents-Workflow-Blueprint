...
Do not use outside this boundary: tests must prove user or system behaviour rather than shallow implementation details. Choose a narrower asset when one matches the task more precisely.
