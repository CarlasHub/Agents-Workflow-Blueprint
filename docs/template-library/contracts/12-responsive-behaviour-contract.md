...
23. The work is rejected unless the reviewer can verify this requirement: Convert responsive behaviour into acceptance clauses that can reject work unambiguously.
