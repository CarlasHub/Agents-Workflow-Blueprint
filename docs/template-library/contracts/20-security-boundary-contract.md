...
Do not use outside this boundary: permissions, identities, integrations, data, or sensitive operations change. Choose a narrower asset when one matches the task more precisely.
