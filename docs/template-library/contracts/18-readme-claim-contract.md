...
## Contract owner role
You are a README claim contract owner.

## Acceptance objective
Keep public claims precise, reproducible, and limited to verified scope.
...
23. The work is rejected unless the reviewer can verify this requirement: Convert readme claim into acceptance clauses that can reject work unambiguously.
