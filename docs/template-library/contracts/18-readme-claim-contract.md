...
Do not use README Claim Contract to perform implementation or manufacture missing evidence. Apply it only to reviewable artefacts produced by the relevant task and procedure.
...
1. The README’s purpose, contents, prerequisites, quick start, and limitations reflect current behavior.
2. Public quality claims are precise, source-mapped, and no stronger than release evidence.
3. Setup commands and navigation links work from a fresh clone or state their prerequisite.
...
- Fresh-path command results and link validation.
- Public-claim scan and repository evidence for each major capability.
