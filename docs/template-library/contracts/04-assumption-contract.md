...
Do not use outside this boundary: assumptions must be named before they influence implementation or review. Choose a narrower asset when one matches the task more precisely.
