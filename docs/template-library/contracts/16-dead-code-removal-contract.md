...
23. The work is rejected unless the reviewer can verify this requirement: Convert dead code removal into acceptance clauses that can reject work unambiguously.
