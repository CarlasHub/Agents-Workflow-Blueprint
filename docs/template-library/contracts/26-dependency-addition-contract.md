...
Do not use outside this boundary: adding packages, frameworks, tools, or external services. Choose a narrower asset when one matches the task more precisely.
