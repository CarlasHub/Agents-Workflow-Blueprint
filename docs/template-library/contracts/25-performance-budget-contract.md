...
Do not use outside this boundary: claims or changes affect performance, rendering cost, API use, or bundle weight. Choose a narrower asset when one matches the task more precisely.
