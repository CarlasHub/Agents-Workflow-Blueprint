...
Do not use outside this boundary: UI work that must preserve semantic structure, keyboard access, and WCAG-aligned reasoning. Choose a narrower asset when one matches the task more precisely.
