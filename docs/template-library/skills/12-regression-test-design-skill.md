...
Do not use outside this boundary: a bug fix or feature needs tests that would catch future breakage. Choose a narrower asset when one matches the task more precisely.
