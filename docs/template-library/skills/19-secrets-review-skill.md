...
Do not use outside this boundary: tokens, env vars, logs, config, or CI may expose secrets. Choose a narrower asset when one matches the task more precisely.
