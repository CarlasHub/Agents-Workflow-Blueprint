...
Do not use outside this boundary: assessing whether prompts produce reliable, honest, and useful agent output. Choose a narrower asset when one matches the task more precisely.
