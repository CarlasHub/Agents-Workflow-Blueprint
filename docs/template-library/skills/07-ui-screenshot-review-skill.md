...
Do not use outside this boundary: screenshots or rendered UI must be audited for defects and state mismatches. Choose a narrower asset when one matches the task more precisely.
