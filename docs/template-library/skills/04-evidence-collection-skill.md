...
Do not use outside this boundary: gathering proof for implementation, review, documentation, or release claims. Choose a narrower asset when one matches the task more precisely.
