...
Do not use outside this boundary: converting a task request into a bounded, reviewable scoping packet. Choose a narrower asset when one matches the task more precisely.
