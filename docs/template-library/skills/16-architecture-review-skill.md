...
Do not use outside this boundary: reviewing boundaries, ownership, coupling, and long-term maintainability. Choose a narrower asset when one matches the task more precisely.
