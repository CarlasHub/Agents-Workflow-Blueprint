...
Do not use outside this boundary: packaging an upgraded repository, template system, or release bundle. Choose a narrower asset when one matches the task more precisely.
