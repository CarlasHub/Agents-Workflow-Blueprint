...
Do not use outside this boundary: reviewing trust boundaries, permissions, secrets, data handling, and abuse paths. Choose a narrower asset when one matches the task more precisely.
