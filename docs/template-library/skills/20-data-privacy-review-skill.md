...
Do not use outside this boundary: personal, tenant, customer, analytics, export, or audit data may be collected or exposed. Choose a narrower asset when one matches the task more precisely.
